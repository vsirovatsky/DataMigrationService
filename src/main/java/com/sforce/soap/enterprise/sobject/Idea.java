...
public class Idea  extends com.sforce.soap.enterprise.sobject.SObject  implements java.io.Serializable {
    ...
    /**
     * Gets the currencyIsoCode value for this Idea.
     * 
    ...
    /**
     * Sets the currencyIsoCode value for this Idea.
     * 
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "IsLocked"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
