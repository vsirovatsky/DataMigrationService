...
public class Call implements javax.xml.rpc.Call {
    ...
    public Object invoke(Object[] params) throws java.rmi.RemoteException {
        ...
        if ( params != null && params.length > 0 && i == params.length ) {
            ...
            System.out.println("setRequestMessage : " + msg.toString());
    ...
    public Object invokeMy(Object[] params) throws java.rmi.RemoteException {
        long t0=0, t1=0;
        if( tlog.isDebugEnabled() ) {
            t0=System.currentTimeMillis();
        }
        ...
        try {
            Object res=this.invokeMy(operationName.getNamespaceURI(),
                    operationName.getLocalPart(), params);
            if( tlog.isDebugEnabled() ) {
                t1=System.currentTimeMillis();
                tlog.debug("axis.Call.invoke: " + (t1-t0)  + " " + operationName);
    ...
    public Object invokeMyCreate(Object[] params) throws java.rmi.RemoteException {
        long t0=0, t1=0;
        if( tlog.isDebugEnabled() ) {
            t0=System.currentTimeMillis();
        }
        ...
        try {
            Object res=this.invokeMyCreate(operationName.getNamespaceURI(),
                    operationName.getLocalPart(), params);
            if( tlog.isDebugEnabled() ) {
                t1=System.currentTimeMillis();
                tlog.debug("axis.Call.invoke: " + (t1-t0)  + " " + operationName);
     ...
     * Invocation
     */
    public Object invokeMyCreate(String namespace, String method, Object[] args)
    throws AxisFault {

    	if (log.isDebugEnabled()) {
    			log.debug("Enter: Call::invoke(ns, meth, args)");
    	}
    	//System.out.println("ZOBO: namespace : " + namespace);
    	//System.out.println("ZOBO: method : " + method);
    	//ListUtils.println(args);
    	System.out.println("HERE INVOKING");
    	...
    	RPCElement body = (RPCElement)args[0];new RPCElement(namespace, method, getParamList(args));
    ...
    public Object invokeMy(String namespace, String method, Object[] args)
    throws AxisFault {
    ...
    public Object invokeMy( RPCElement body ) throws AxisFault {
        if (log.isDebugEnabled()) {
        ...
        System.out.println("ZOBO: BODY: " + body.toString());
        SOAPEnvelope         reqEnv =
        ...
        try {
            ...
            System.out.println("ZOBO: reqEnv: " + reqEnv.toString());
            invoke();
        } catch (Exception e) {
        ...
        if (bodyEl instanceof RPCElement) {
            try {
            	RPCElement el1 = (RPCElement) bodyEl;
            	if ( el1 != null ) {
            		return el1;
            	}
        ...
        if (bodyEl instanceof RPCElement) {
            ...
            if (resArgs != null && resArgs.size() > 0) {
                ...
                for (int i = outParamStart; i < resArgs.size(); i++) {
                    ...
                    if (javaType != null && value != null &&
                           !javaType.isAssignableFrom(value.getClass())) {
                    	System.out.println("ZOBO: javaType : " + javaType);
                    	System.out.println("ZOBO: value : " + value);
                        value = JavaUtils.convert(value, javaType);
                    }
